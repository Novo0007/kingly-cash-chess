            ...
            <div className="border-l-4 border-blue-500 pl-6">
              ...
              <div className="bg-blue-50 p-4 rounded-xl space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-white p-2 rounded-lg">
                      <strong className="text-blue-700">3|0</strong> - 3
                      minutes, no increment
                    </div>
                    <div className="bg-white p-2 rounded-lg">
                      <strong className="text-blue-700">5|3</strong> - 5 minutes
                      + 3 sec/move
                    </div>
                    <div className="bg-white p-2 rounded-lg">
                      <strong className="text-blue-700">10|0</strong> - 10
                      minutes total
                    </div>
                    <div className="bg-white p-2 rounded-lg">
                      <strong className="text-blue-700">15|10</strong> - 15 min
                      + 10 sec/move
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3 bg-red-100 border-l-4 border-red-500 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    <strong>Running out of time results in a loss</strong>{" "}
                    unless the opponent cannot checkmate (insufficient material
                    = draw).
                  </p>
                </div>
              </div>
