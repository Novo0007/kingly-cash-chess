...
export const ChessBoard: React.FC<ChessBoardProps> = ({
  ...
  return (
    <div className="flex flex-col items-center w-full px-1 sm:px-2">
      <div className="bg-gradient-to-br from-black via-purple-900 to-black p-3 sm:p-6 md:p-8 rounded-xl shadow-2xl w-full max-w-full sm:max-w-4xl md:max-w-5xl lg:max-w-6xl xl:max-w-7xl border-4 border-yellow-400">
        <div
          ref={boardRef}
