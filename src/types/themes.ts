...
export const themes: ThemeDefinition[] = [
  ...
  },
  {
    ...
    name: "Charcoal",
    description:
      "Deep dark theme with elegant charcoal tones and subtle blue accents",
    preview: "🌑",
    colors: {
      background: "210 15% 8%",
  ...
  },
  {
    ...
    name: "Soft Sunrise",
    description:
      "Warm light theme with gentle sunrise colors and peachy gradients",
    preview: "🌅",
    colors: {
      background: "30 40% 98%",
      foreground: "30 20% 12%",
      ...
      secondary: "35 30% 88%",
      secondaryForeground: "30 20% 12%",
      muted: "30 20% 92%",
      mutedForeground: "30 15% 45%",
      accent: "15 75% 75%",
      accentForeground: "30 20% 12%",
      destructive: "0 80% 60%",
    ...
    gradients: {
      primary: "from-orange-300 to-pink-300",
      secondary: "from-amber-200 to-orange-200",
